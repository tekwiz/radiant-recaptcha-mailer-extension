...
If you wish to add recaptcha validation, just install the recaptcha extension from http://github.com/tekwiz/radiant-recaptcha-extension and add the tag to your form page.
